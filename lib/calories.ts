...
const CARDIO_MET: Record<string, Record<CardioIntensity, number>> = {
  ...
  "basketball pickup": { easy: 6.5, moderate: 8.0, hard: 10.0 },
  "pickup basketball": { easy: 6.5, moderate: 8.0, hard: 10.0 },
  basketball: { easy: 5.0, moderate: 6.5, hard: 8.0 },
  soccer: { easy: 5.0, moderate: 7.0, hard: 10.0 },
  "soccer pickup": { easy: 5.0, moderate: 7.0, hard: 10.0 },
  "pickup soccer": { easy: 5.0, moderate: 7.0, hard: 10.0 },
  football: { easy: 4.5, moderate: 8.0, hard: 9.0 },
  tennis: { easy: 4.5, moderate: 7.3, hard: 8.0 },
  volleyball: { easy: 3.0, moderate: 4.0, hard: 6.0 },
  "volleyball pickup": { easy: 3.0, moderate: 4.0, hard: 6.0 },
  "pickup volleyball": { easy: 3.0, moderate: 4.0, hard: 6.0 },
